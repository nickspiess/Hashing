...
public class HashChain<K, V>{
	...
	*/
	public void insert(HashNode<K,V> hn){
		// for separate chain we want to keep load around 10 or less
		if (calcLoad() > 10) {
			rehash();
		}
	...
	*/
	public void rehash(){
		...
		// Initialize SLList so they are not null
	...
	*/
	...
	public void remove(K key, V value){
		...
		//System.out.println(value + " is not in the table, we cannot remove it");
		//System.out.println();
	}
